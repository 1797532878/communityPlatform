                ...
                <div class="cart-top-items" v-for="(item,index) in carPanelData">
                  <div class="cart-items">
                    <div class="items-choose">
                      <span class="blue-checkbox-new " :class="{'checkbox-on':item.checked}" @click="checkGoods(item.sku_id)"><a></a></span>
                    </div>
                    ...
                    <div class="item-cols-num">
                      <div class="select js-select-quantity">
                        <span class="down" @click="subCarPanelData(item.sku_id)" :class="{'down-disabled':item.count <= 1}">-</span>
                        <span class="num">
												  {{item.count}}
                        </span>
                        <span class="up" @click="plusCarPanelData(item.sku_id)" :class="{'up-disabled':item.count>=item.limit_num}">+</span>
          ...
          <div class="cart-bar-operation">
            <div>
              <div class="choose-all js-choose-all">
                <span class="blue-checkbox-new " :class="{'checkbox-on':allChecked}" @click="allCheckGoods(allChecked)"><a></a></span>
                全选
              </div>
              <div class="delete-choose-goods" @click="delCheckedGoods">删除选中的商品</div>
            </div>
          </div>
          <div class="shipping">
            <div class="shipping-box">
              <div class="shipping-total shipping-num">
                <span class="shipping-total-h4">
            ...
            <el-button tag="span" class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn': checkedCount <= 0}" @click="toCheckOut"><a>现在结算</a></el-button>
          </div>
        </div>
      </div>
    </div>
