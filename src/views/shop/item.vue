            ...
            <div class="thumbnail">
              <ul>
                <li :class="{'on':index== imgIndex}"  @click="tableImg(index)"
                  ...
                  <img class="img" :src="img+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'">
                </li>
              </ul>
            </div>
            <div class="thumb">
        ...
        <div class="banner">
            ...
            <div class="sku-dynamic-params clear">
              ...
              <ul class="params-colors">
                <li :class="{'cur':color.id==$route.query.itemId}" v-for="(color,index) in itemsInfo.sku_list">
                  <router-link :to="{name: 'Item', query: {itemId:color.id}}" :title="color.color"></router-link>
                </li>
              </ul>
            </div>
            <div class="sku-dynamic-params clear">
          ...
          <div class="sku-status">
            <div class="cart-operation-wrapper clearfix">
              ...
              <span  class="gray-title-btn" @click="addCarPanel">现在购买</span>
            </div>
          </div>
        </div>
      </div>
